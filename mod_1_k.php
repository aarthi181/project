<html>
<head>
	<title>Module 1: Kinesthetic</title>
...
<body>
	...
	<div class="main">
		...
		<div class="card effect__hover">
			...
			<div class="card__back col1">
				<span class="card__text"><p>the application of a systematic disciplined quantifiable approach to the development, operation and maintenance of software</p></span>
			</div>
		</div>
	...
	<div class="carousel">
		<div class="item col5 slide-in" id="item6" tabindex="6"><p>&#10126; problems measuring progress</p></div>
		<div class="item col4 slide-in" id="item5" tabindex="5"><p>&#10125; time and effort required for maintenance</p></div>
		<div class="item col3 slide-in" id="item4" tabindex="4"><p>&#10124; errors discovered after extensive testing</p></div>
		<div class="item col2 slide-in" id="item3" tabindex="3"><p>&#10123; high cost</p></div>
		<div class="item col1 slide-in" id="item2" tabindex="2" autofocus><p>&#10122; meeting deadlines</p></div>
		<input type="checkbox" autofocus="autofocus" tabindex="1" />
		<div class="item col slide-in" id="item1" tabindex="1" autofocus><p>Some issues that are encountered when developing software include:</p></div>
		<div class="controls">
			...
			<a href="#item6" class="btn" tabindex="-1"></a>
		</div>
	</div>
	<div class="main">	
