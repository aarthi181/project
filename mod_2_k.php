...
<body>
	...
	<div class="main">
		...
		<div class="carousel">
		<div class="item col4 slide-in" id="item4" tabindex="4"><p>&#10125; One problem of the waterfall method is that a working version of the system is only available late in the project</p></div>
		<div class="item col3 slide-in" id="item3" tabindex="3"><p>&#10124; This method can only be used when all the customer requirements are known at the beginning of the project</p></div>
		<div class="item col2 slide-in" id="item2" tabindex="2"><p>&#10123; Some versions provide feedback loops from each stage to the previous ones</p></div>
		<input type="checkbox" autofocus="autofocus" tabindex="1" />
		<div class="item col1 slide-in" id="item1" tabindex="1" autofocus><p>&#10122; A simple linear model that is considered a 'first approximation' of the activities needed</p></div>
		<div class="controls">
