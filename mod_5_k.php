<html>
<head>
	<title>Module 5: Kinesthetic</title>
...
<body>
	...
	<div class="main">
		...
		<div class="carousel">
			<div class="item col3 slide-in" id="item4" tabindex="4"><p>Software is being increasingly designed to be extensible with the incremental addition of functionality making it impossible to anticipate the kind of updates that may be downloaded</p></div>
			<div class="item col2 slide-in" id="item3" tabindex="3"><p>Increasing access to applications through various computer network technologies adds considerably to the security risks</p></div>
			<div class="item col1 slide-in" id="item2" tabindex="2"><p>The increasing complexity of systems make them more difficult to understand and hence more difficult to secure</p></div>
			<input type="checkbox" autofocus="autofocus" tabindex="1" />
			<div class="item col slide-in" id="item1" tabindex="1" autofocus><p>Three trends are often cited as introducing security risks into systems and contributing to the magnitude of the security problem today </p></div>
			<div class="controls">
		...
		<h2>Principles for Software Security</h2>
